   ...
   <body onload="remove()">
      <div id="principal">
            ...
            <div class="conteudo aberto">
               ...
               <div class="painel">
                  <div class="painel_titulo">
                     <h4><i class="fa fa-pencil"></i> Editar Serviço</h4>
                  </div>
                    ...
                    <form name="formulario" id="formulario" method="POST" action="" onsubmit="">
                      ...
                      <div class="row">
                        <div class="form-group col-md-4">
                           ...
                           <select  id='categoria' name='categoria' class="form-control valid" >
                              <option value="<?php echo $servico['sercatid']; ?>"  selected><?php echo $servico['catdescricao']; ?></option>
                              <?php
                                   if(!$result){
                      ...
                      <div class="row">
                        <div class="form-group col-md-8">
                          ...
                          <input type="text" class="form-control" name="descricao" id="descricao" minlength="2" maxlength="50" placeholder="" value="<?php echo $servico['serdescricao']; ?>" required />
                        </div>
                      </div>
                      ...
                      <div class="row">
                        <div class="col-md-12">
                          <div style="float:left;">
                            <button type="submit" id="editarServico" name="editarServico" class="btn btn-primary enviar-dados">Guardar</button>
         ...
         <?php
            ...
            include '../../assets/js/editarServico.js';
         ?>
         <!-- FIM MODAL - DELETAR -->
