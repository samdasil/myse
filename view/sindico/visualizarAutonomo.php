            ...
            <div class="conteudo aberto">
               ...
               <div class="painel">
                  <div class="painel_titulo">
                     <h4><i class="fa fa-briefcase"></i> Visualizar dados do Autônomo</h4>
                  </div>
                    ...
                    <form name="formulario" id="formulario" method="POST" action="" onsubmit="">
                      ...
                      <div class="row">
                        <div class="form-group col-md-8">
                          ...
                          <input type="text" class="form-control" name="nome" id="nome" minlength="4" maxlength="50" placeholder="Digite o nome do autonomo" value="<?php echo $autonomo['autnome']; ?>" readonly />
                        </div>
                      </div>
                      ...
                      <div class="row">
                        ...
                        <div class="form-group col-md-5">
                          ...
                          <input type="email" class="form-control" name="email" id="email" minlength="4" maxlength="80" placeholder="exemplo@email.com" value="<?php echo $autonomo['autemail']; ?>" readonly />
                        </div>
                      </div>
                      ...
                      <div class="row">
                        <div class="col-md-12">
                          <div style="float:left;">
                            ...
                            <a href="listarAutonomo.php"><button type="button"  name="cancelar" class="btn btn-default">Voltar</button></a>
                          </div>
                        </div>
                      </div>
