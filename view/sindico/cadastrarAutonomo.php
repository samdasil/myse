   ...
   <body onload="remove()">
      <div id="principal">
            ...
            <div class="conteudo aberto">
               ...
               <div class="painel">
                  <div class="painel_titulo">
                     <h4><i class="fa fa-briefcase"></i> Novo Autônomo</h4>
                  </div>
                    ...
                    <form name="formulario" id="formulario" method="POST" action="." onsubmit="">
                      ...
                      <div class="row">
                        <div class="form-group col-md-8">
                          ...
                          <input type="text" class="form-control" name="nome" id="nome" minlength="4" maxlength="50" placeholder="Digite o nome do autônomo" autocapitalize required autofocus >
                        </div>
                      </div>
                     ...
                     <input type="text"  name="perfil" id="perfil" minlength="1" maxlength="8" width="10%" placeholder="" value="" hidden/>


                      <div class="row">
                        <div class="col-md-12">
                          <div style="float:left;">
                            <button type="submit" id="cadastrarAutonomo" name="cadastrarAutonomo" class="btn btn-primary enviar-dados">Salvar</button>
         ...
         <?php
            ...
            include '../../assets/js/cadastrarAutonomo.js';
         ?>
