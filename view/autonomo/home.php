            ...
            <div class="conteudo aberto">
               ...
               <div class="painel">
                  <div class="painel_titulo">
                     <h4><i class="fa fa-home"></i>&nbsp Olá Sr(a) <?php echo $autonomo['autnome']; ?> </h4>
                  </div>
                  <div class="painel_corpo">

                      <div class="linha">
                        <div class="col1">
                          <a href="visualizarAutonomo.php?id=<?php echo $autonomo['autid']; ?>"><i class="fa fa-user fa-5x"></i></a><br>
                          <label class="label-icone">PERFIL</label>
                        </div>
                        <div class="col2">
                          <a href="listarNovasSolicitacoes.php?id=<?php echo $autonomo['autid']; ?>"><i class="fa fa-bullhorn fa-5x"></i></a>
                          <label class="label-icone">SOLICITAÇÕES</label>
                        </div>
                      </div>
                      <div class="linha">
                        <div class="col1">
                          <a href="listarHistorico.php?id=<?php echo $autonomo['autid']; ?>"><i class="fa fa-th-list fa-5x"></i></a>
                          <label class="label-icone">HISTÓRICO</label>
                        </div>
                        <div class="col2">
                          <a href="listarMeusAtendimentos.php?id=<?php echo $autonomo['autid']; ?>"><i class="fa fa-bookmark fa-5x"></i></a>
                          <label class="label-icone">ATENDIMENTOS</label>
                        </div>
                      </div>
                      <div class="linha">
                        <div class="col1">
                          <a href="visualizarNota.php?id=<?php echo $autonomo['autid']; ?>"><i class="fa fa-star fa-5x"></i></a>
                          <label class="label-icone">NOTA</label>
                        </div>
                        <div class="col2">
                          <a href="creditos.php?id=<?php echo $autonomo['autid']; ?>"><i class="fa fa-coffee fa-5x"></i></a>
