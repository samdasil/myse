...
<html lang="pt-br">
   ...
   <body onload="remove()">
      <div id="principal">
         ...
         <div class="conteudoTotal">
            ...
            <div class="sidebar">
               ...
               <ul class="nav">
                  ...
                  <li>
                     <a class="ativo" href="listarNovasSolicitacoes.php?id=<?php echo $autonomo['autid']; ?>">Solicitações</a>
                  </li>
                  <li>
            ...
            <div class="conteudo aberto">
               ...
               <div class="painel">
                  <div class="painel_titulo">
                     <h4><i class="fa fa-bullhorn"></i> &nbsp Visualizar Solicitação</h4>
                  </div>
                  ...
                  <div class="painel_corpo">
                    ...
                    <form name="formulario" id="formulario" method="POST" action="" onsubmit="">
                      ...
                      ?>
                        ...
                        <div class="row">
                          <div class="form-group col-md-2">
                            <label for="complemento">Localização</label>
                            <input type="text"  name="local" id="local"  value="<?php echo $solicitacao['clicomplemento']; ?>" hidden >
                            <input type="text" class="form-control" name="local" id="local"  value="<?php echo $solicitacao['clicomplemento']; ?>" readonly >
                          </div>
                        </div>
                        ...
                        <div class="row">
                          <div class="col-md-12">
                            ...
                            <div style="float:right;">
                              <a class="btn btn-success btn-xs" data-toggle="modalConfirmacao" data-id="<?php echo $solicitacao['solid']; ?>" data-aut="<?php echo $autonomo['autid']; ?>" href=""><i class="fa fa-check fa-3x"></i><br>Atender</a>
                            </div>
                          </div>
                        </div>
         ...
         <?php
            require '../layout/infoConfirmacao.php';
            include '../../assets/js/confirmarAtendimento.js';
         ?>
         <!-- FIM MODAL - DELETAR -->
