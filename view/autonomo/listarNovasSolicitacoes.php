            ...
            <div class="conteudo aberto">
               ...
               <div class="painel">
                  <div class="painel_titulo">
                      <h4><i class="fa fa-bullhorn"></i> Novas Solicitações
                            ...
                            <div class="table-responsive col-md-12">
                              <?php
                                  ...
                                  if(isset($_POST['buscarSolicitacao'])){
                                    include  '../../control/controlBuscarNovasSolicitacoes.php';
                                  }else{
                                    include '../../control/controlListarNovasSolicitacoes.php';
                                  }
                              ?>
                                   ...
                                   ?>
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                              <?php if($solicitacao['solstatus'] == 'Aguardando autônomo') { ?>
                                                      <a class="btn btn-light btn-xs" style="pointer-events:none; color:#df3737;" href="#"><i class="fa fa-hourglass-start"></i></a>
                                              <?php } ?>
                                            </td>
                                            <td class="actions">
