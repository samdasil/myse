   ...
   <body onload="remove()">
      <div id="principal">
         ...
         <div class="conteudoTotal">
            ...
            <div class="sidebar">
               ...
               <ul class="nav">
                  ...
                  <li>
                     <a href="listarHistorico.php?acao=visualizar?id=<?php echo $autonomo['autid']; ?>">Histórico</a>
                  </li>
                  <li>
                     <a href="listarMeusAtendimentos.php?acao=visualizar?id=<?php echo $autonomo['autid']; ?>">Atendimentos</a>
                  </li>
                  <li>
                     <a href="visualizarNota.php?acao=visualizar?id=<?php echo $autonomo['autid']; ?>">Nota</a>
                  </li>
                  <li>
                     <a href="creditos.php?acao=visualizar?id=<?php echo $autonomo['autid']; ?>">Créditos</a>
                  </li>
                  <li>
            ...
            <div class="conteudo aberto">
               ...
               <div class="painel">
                  <div class="painel_titulo">
                     <h4><i class="fa fa-pencil"></i> Editar Meu Perfil</h4>
                  </div>
                    ...
                    <form name="formulario" id="formulario" method="POST" action="" onsubmit="">
                      ...
                      <div class="row">
                        <div class="form-group col-md-3">
                          ...
                          <input type="text" class="form-control" name="fone" id="fone" minlength="4" maxlength="50" placeholder="" value="<?php echo $autonomo['autfone']; ?>" required />
                        </div>
                        <div class="form-group col-md-5">
                          <label for="email">Fone</label>
                          <input type="email" class="form-control" name="email" id="email" minlength="4" maxlength="80" placeholder="" value="<?php echo $autonomo['autemail']; ?>" required />
                        </div>
                      </div>
                      ...
                      <div class="row">
                        ...
                        <div class="form-group col-md-3">
                          ...
                          <input type="text" class="form-control" name="bairro" id="bairro" minlength="1" maxlength="8" width="100%" placeholder="bairro" value="<?php echo $autonomo['autbairro']; ?>" required/>
                        </div>
                      </div>
                      <div class="row">
                        <div class="form-group col-md-5">
                          <label for="cidade">Cidade</label>
                          <input type="text" class="form-control" name="cidade" id="cidade" minlength="8" maxlength="120" width="100%" placeholder="" value="<?php echo $autonomo['autcidade']; ?>" required/>
                        </div>
                        <div class="form-group col-md-3">
                          <label for="uf">UF</label>
                          <input type="text" class="form-control" name="uf" id="uf" minlength="1" maxlength="8" width="100%" placeholder="" value="<?php echo $autonomo['autuf']; ?>" required/>
                        </div>
                      </div>
                      <br>
                      ...
                      <div class="row">
                        <div class="col-md-12">
                          ...
                          <div style="float:right;">
                            <button type="submit" id="editarAutonomo" name="editarAutonomo" class="btn btn-primary enviar-dados"><i class="fa fa-save fa-3x"></i></button>
                          </div>
                        </div>
                      </div>
         ...
         <?php
            ...
            include '../../assets/js/editarPerfilAutonomo.js';
         ?>
         <!-- FIM MODAL - DELETAR -->
