            ...
            <div class="conteudo aberto">
               ...
               <div class="painel">
                  <div class="painel_titulo">
                      <h4><i class="fa fa-bullhorn"></i>&nbspMeus Atendimentos
                            ...
                            <div class="table-responsive col-md-12">
                              <?php
                                  ...
                                  if(isset($_POST['buscarSolicitacao'])){
                                    include  '../../control/controlBuscarMeusAtendimentos.php';
                                  }else{
                                    include '../../control/controlListarMeusAtendimentos.php';
                                  }
                              ?>
                                   ...
                                   ?>
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                              <?php if($solicitacao['solstatus'] == 'Pendente') { ?>
                                                      <a class="btn btn-light btn-xs" style="pointer-events:none; color:#df3737;" href="#"><i class="fa fa-exclamation-triangle fa-2x"></i></a>
                                              <?php } ?>
                                            </td>
                                            <td class="actions">
                                                <a class="btn btn-success btn-xs" href="finalizarSolicitacao.php?acao=visualizar&sol=<?php echo $solicitacao['solid']; ?>&id=<?php echo $autonomo['autid']; ?>"><i class="fa fa-eye"></i></a>
