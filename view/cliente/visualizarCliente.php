                    ...
                    <form name="formulario" id="formulario" method="POST" action="" onsubmit="">
                      ...
                      <div class="row">
                        <div class="form-group col-md-8">
                          ...
                          <input type="text" class="form-control" name="condominio" id="condominio" minlength="6" maxlength="7" placeholder="" value="<?php echo $cliente['connome']; ?>" autocapitalize readonly >
                        </div>
                      </div>
                      ...
                      <div class="row">
                        <div class="form-group col-md-8">
                          ...
                          <input type="text" class="form-control" name="nome" id="nome" minlength="4" maxlength="50" placeholder="teste" value="<?php echo $cliente['clinome']; ?>" readonly />
                        </div>
                      </div>
                      ...
                      <div class="row">
                        <div class="form-group col-md-3">
                          ...
                          <input type="text" class="form-control" name="fone" id="fone" minlength="4" maxlength="50" placeholder="" value="<?php echo $cliente['clifone']; ?>" readonly />
                        </div>
                        <div class="form-group col-md-5">
                          <label for="email">Fone</label>
                          <input type="email" class="form-control" name="email" id="email" minlength="4" maxlength="80" placeholder="" value="<?php echo $cliente['cliemail']; ?>" readonly />
                        </div>
                      </div>
                      ...
                      <div class="row">
                        <div class="form-group col-md-2">
                          ...
                          <input type="text" class="form-control" name="cep" id="cep" minlength="0" maxlength="15" width="100%" placeholder="cep" value="<?php echo $cliente['clicep']; ?>" readonly />
                        </div>
                        <div class="form-group col-md-2">
                          <label for="numero">Número</label>
                          <input type="text" class="form-control" name="numero" id="numero" minlength="1" maxlength="8" width="10%" placeholder="xxxx" value="<?php echo $cliente['clinumero']; ?>" readonly/>
                        </div>
                        <div class="form-group col-md-4">
                          <label for="complemento">Complemento</label>
                          <input type="text" class="form-control" name="complemento" id="complemento" minlength="0" maxlength="80" width="100%" value="<?php echo $cliente['clicomplemento']; ?>" readonly />
                        </div>
                      </div>
                      <div class="row">
                        <div class="form-group col-md-5">
                          <label for="rua">Rua</label>
                          <input type="text" class="form-control" name="rua" id="rua" minlength="8" maxlength="120" width="100%" placeholder="Digite o nome da rua" value="<?php echo $cliente['clirua']; ?>" readonly/>
                        </div>
                        <div class="form-group col-md-3">
                          <label for="bairro">Bairro</label>
                          <input type="text" class="form-control" name="bairro" id="bairro" minlength="1" maxlength="8" width="100%" placeholder="bairro" value="<?php echo $cliente['clibairro']; ?>" readonly/>
                        </div>
                      </div>
                      <div class="row">
                        <div class="form-group col-md-5">
                          <label for="cidade">Cidade</label>
                          <input type="text" class="form-control" name="cidade" id="cidade" minlength="8" maxlength="120" width="100%" placeholder="" value="<?php echo $cliente['clicidade']; ?>" readonly/>
                        </div>
                        <div class="form-group col-md-3">
                          <label for="uf">UF</label>
                          <input type="text" class="form-control" name="uf" id="uf" minlength="1" maxlength="8" width="100%" placeholder="" value="<?php echo $cliente['cliuf']; ?>" readonly/>
                        </div>
                      </div>
                      <br>
                      ...
                      <div class="row">
                          <div class="form-group col-md-3">
                            ...
                            <input type="text" class="form-control" name="login" id="login" minlength="3" maxlength="20" width="100%" placeholder="login" value="<?php echo $cliente['clilogin']; ?>" readonly/>
                          </div>
                          <div class="form-group col-md-3">
                      ...
                      <div class="row">
                        <div class="col-md-12">
                          ...
                          <div style="float:right;">
                            <a class="btn btn-success btn-xs" href="editarCliente.php?acao=editar&id=<?php echo $cliente['cliid']; ?>"><i class="fa fa-pencil fa-3x"></i></a>
                          </div>
                        </div>
                      </div>
